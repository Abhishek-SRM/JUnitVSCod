...
public class T001_ADDDEC {

	static String inputXMLFilePath = "testcases/junitvscod.repository.imported.tests/T001_ADDDEC.xml";
	String input;
	...
	public T001_ADDDEC(String input, String expectedResult, String compareJson) {
		this.input = input;
	...
	public static Collection<String[]> testData() {
		return XMLUtils.getTestData("resources/junitvscod.repository.imported.tests/T001_ADDDEC");
	}
}