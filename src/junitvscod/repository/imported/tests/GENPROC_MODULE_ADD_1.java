...
public class GENPROC_MODULE_ADD_1 {

    static String inputXMLFilePath = "testcases/junitvscod.repository.imported.tests/GENPROC_MODULE_ADD_1.xml";
    String input;
    ...
    public GENPROC_MODULE_ADD_1(String input, String expectedResult, String compareJson) {
        this.input = input;
    ...
    public static Collection<String[]> testData() {
        return XMLUtils.getTestData("resources/junitvscod.repository.imported.tests/GENPROC_MODULE_ADD_1");
    }
    ...
    public void test() throws Exception {
        String actualResult = TestCaseExecutionHelper.executeTestCase(inputXMLFilePath, input, expectedResult, compareJson);
