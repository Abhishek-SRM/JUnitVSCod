...
public class ADDNUM_SRVPGM_SUM {
    ...
    static String inputXMLFilePath = "testcases/junitvscod.repository.imported.tests/ADDNUM_SRVPGM_SUM.xml";
    String input;
    ...
    public static Collection<String[]> testData() {
        return XMLUtils.getTestData("resources/junitvscod.repository.imported.tests/ADDNUM_SRVPGM_SUM");
    }
