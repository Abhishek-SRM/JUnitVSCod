...
public class T001_SUBTRACT {

	static String inputXMLFilePath = "testcases/junitvscod.repository.imported.tests/T001_SUBTRACT.xml";
	String input;
	...
	public T001_SUBTRACT(String input, String expectedResult, String compareJson) {
		this.input = input;
	...
	public static Collection<String[]> testData() {
		return XMLUtils.getTestData("resources/junitvscod.repository.imported.tests/T001_SUBTRACT");
	}
}