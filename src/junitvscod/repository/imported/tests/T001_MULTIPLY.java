...
public class T001_MULTIPLY {

    static String inputXMLFilePath = "testcases/junitvscod.repository.imported.tests/T001_MULTIPLY.xml";
    String input;
    ...
    public T001_MULTIPLY(String input, String expectedResult, String compareJson) {
        this.input = input;
    ...
    public static Collection<String[]> testData() {
        return XMLUtils.getTestData("resources/junitvscod.repository.imported.tests/T001_MULTIPLY");
    }
