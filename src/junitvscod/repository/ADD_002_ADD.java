...
public class ADD_002_ADD {

	static String inputXMLFilePath = "testcases/junitvscod.repository/ADD_002_ADD.xml";
	String input;
	...
	public ADD_002_ADD(String input, String expectedResult, String compareJson) {
		this.input = input;
	...
	public static Collection<String[]> testData() {
		return XMLUtils.getTestData("resources/junitvscod.repository/ADD_002_ADD");
	}
