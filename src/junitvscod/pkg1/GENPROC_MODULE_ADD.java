package junitvscod.pkg1;
    ...
    public class GENPROC_MODULE_ADD {
        ...
        static String inputXMLFilePath = "testcases/junitvscod.pkg1/$(project) JUnitVSCod.xml";
        String input;
        ...
        public static Collection<String[]> testData() {
            return XMLUtils.getTestData("resources/junitvscod.pkg1/$(project) JUnitVSCod");
        }
    }