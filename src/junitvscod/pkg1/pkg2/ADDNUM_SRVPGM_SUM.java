package junitvscod.pkg1.pkg2;
    ...
    public class ADDNUM_SRVPGM_SUM {
        ...
        static String inputXMLFilePath = "testcases/junitvscod.pkg1.pkg2/$(symbol-namespace) junitvscod.xml";
        String input;
        ...
        public static Collection<String[]> testData() {
            return XMLUtils.getTestData("resources/junitvscod.pkg1.pkg2/$(symbol-namespace) junitvscod");
        }
    }